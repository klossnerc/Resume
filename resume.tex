...
\experience{Air-Weigh}
	...
	- Wrote a pictorial how-to guide for using a new tool that created processor initialization code
...
\experience{Garmin AT}
	...
	- Developed a serial-peripheral interface (SPI) driver from initial code to software tests that was added to the operating system

	- Helped teach an overview of key kernel development concepts to new software developers
...
\skill{Languages}{Fluent in C, familiar with Java, basic understanding of Haskell and Python}

\skill{Tools}{Experienced with oscilloscope, basic understanding of GNU debugger}
